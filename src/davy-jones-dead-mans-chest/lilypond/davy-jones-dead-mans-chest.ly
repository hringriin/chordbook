...
\header {
  title = "Davy Jones (from Pirates of the Caribbean: Dead Man's Chest)"
  composer = \markup { \bold {Music:} Hans Zimmer}
  arranger = \markup { \bold {Arrangement:} Eddie van der Meer}
  instrument = "Guitar"
