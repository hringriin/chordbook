...
\beginsong{Der Wandersmann}[%
    ...
    \beginchorus\replay[chorus]
        \lrep Es fl\[C]ie\ss{}t der Wein, es fl\[G]ie\ss{}t das Bier!
        H\[F]och die Kr\"{u}ge tr\[G]inken wir! \rrep \rep{3}
        \vspace{1cm}
        Es fl\[C]ie\ss{}t der Wein, es fl\[G]ie\ss{}t das Bier!
        H\[F]och die Kr\"{u}ge tr\[G]inken w\[C]ir!
        \par\bigskip
        \textnote{Letzte Zeile mit Ritardando, das "`wir"' lange halten.}
    \endchorus
\endsong
